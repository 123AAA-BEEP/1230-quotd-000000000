...
5. **City pages must differ.** A city page needs at least three facts that are true only of that city (geology, permit authority and rules, climate, local jobs) and under 35% prose overlap with any other city page. Stoney Creek and Ancaster are sections of Hamilton, not pages. Toronto is not a service area.
